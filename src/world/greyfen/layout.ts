...
const placements: Placement[] = [
  ...
  { kind: "stiltHut", x: -70, z: 84, rotY: Math.PI / 2 },
  { kind: "stiltHut", x: -56, z: 86, rotY: -Math.PI / 2 },
  { kind: "stiltHut", x: -66, z: 96 },
  { kind: "boardwalk", x: -63, z: 84.5, rotY: Math.PI / 2, params: { length: 11, railSide: "none" } },
  { kind: "boardwalk", x: -63, z: 89.5, params: { length: 9, railSide: "none" } },
  ...
  { kind: "boardwalk", x: 0, z: 25, params: { length: 12 } },
  { kind: "boardwalk", x: 0, z: 37, params: { length: 12 } },
  { kind: "boardwalk", x: 0, z: 48, params: { length: 11 } },
  { kind: "stiltHut", x: 6, z: 31, rotY: Math.PI / 2 },
  { kind: "stiltHut", x: -6, z: 42, rotY: -Math.PI / 2 },
